<!-- Begin Page Content -->
    <div class="container-fluid sizealert">
      <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">เพิ่มข้อมูลผู้ผลิต/ร้านค้าส่ง</h1>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">เพิ่มข้อมูลผู้ผลิต/ร้านค้าส่ง</h6>
            </div>
            <div class="card-body">
              <div class="container">
                  ...
                  <div class="col-sm-12 col-md-12"> 
                      ...
                      <div class="form-group row">
                        ...
                        <label for="inputEmail3" class="col-sm-3 col-form-label"><b>ชื่อผู้ผลิต/ร้านค้าส่ง</b></label>
                     
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="supplier_name" name="supplier_name" placeholder="ชื่อสินค้า ...">
                        </div>
                      </div>

                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label"><b>ที่อยู่</b></label>
                        <div class="col-sm-8">
                       ...
                       <div class="form-group row">
                          ...
                          <label for="inputEmail3" class="col-sm-3 col-form-label"><b>เบอร์โทร</b></label>
                       
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="supplier_phone" name="supplier_phone" placeholder="เบอร์โทร ..." maxlength="10">
                        </div>
                      </div>

                      <div class="form-group row">
                        
                          <label for="inputEmail3" class="col-sm-3 col-form-label"><b>Line</b></label>
                      
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="supplier_line" name="supplier_line" placeholder="Line ...">
                        </div>
                      </div>

                      <div class="form-group row">
                       
                          <label for="inputEmail3" class="col-sm-3 col-form-label"><b>Feacbook</b></label>
                        
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="supplier_feacbook" name="supplier_feacbook" placeholder="Feacbook ...">
                        </div>
                      </div>
