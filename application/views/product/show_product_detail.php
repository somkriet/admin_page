...
if(!empty($product_detail_data)): 
   foreach ($product_detail_data as $row) {

    $data_product_id = $row->product_id;
    $data_product_name = $row->product_name;
    $data_product_img = $row->product_img;
    $data_category = $row->category;
    $data_productDiscription = $row->productDiscription;
    $data_total_stock = $row->total_stock;
    $data_score = $row->score;
    $data_store = $row->store;
    $data_unit_count = $row->unit_count;
    $data_product_minimum = $row->product_minimum;
    $data_Supplier = $row->Supplier;
    $data_status = $row->status;
    $data_date_product = $row->date_product;

    }
endif;

// if(!empty($product_option_data)): 
//    foreach ($product_option_data as $row) {

//     $data_run_number = $row->run_number;
//     $data_product_id = $row->product_id;
//     $data_option_product = $row->option_product;
//     $data_sku = $row->sku;
//     $data_barcode = $row->barcode;
//     $data_stock = $row->stock;
//     $data_cost = $row->cost;
//     $data_sale_price = $row->sale_price;
//     $data_date_option = $row->date_option;
                  ...
                  <div class="col-sm-12 col-md-12"> 
                    <!-- <form> -->
                      ...
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label"><b>รหัสสินค้าสินค้า</b></label>
                        <div class="col-sm-8">

                          <?php echo $data_product_id;?>
                          <!-- <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $data_product_name;?>"> -->
                        </div><!-- <?php echo $product_name;?> -->
                      </div>
                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <input type="hidden" id="product_category_value" name="product_category_value" value="<?php echo $data_category; ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <input type="hidden" id="product_detail_value" name="product_detail_value" value="<?php echo $data_productDiscription;?>">
                      ...
                      <hr>
                      <center>
                        <img src="<?php echo base_url('uploads/'.$data_product_img);?>" width="200" height="250" style="border:1px solid black" >
                      </center><br>
                            ...
                            <tbody>
                              ...
                              if(!empty($product_option_data)): 
                                  foreach ($product_option_data as $row) {?>
                                        ...
                                        <tr class="firstTr">
                                            <td>
                                                <input class="form-control option" name="option[]" type="text" id="option1" maxlength="256" value="<?php echo $row->option_product; ?>">
                                                <span style=" font-size: 15px;">ตัวอย่าง: Size S, สีดำ</span>
                                            </td>
                                            <td>
                                               <input class="form-control sku" name="sku[]" type="text" id="sku1" maxlength="256" value="<?php echo $row->sku; ?>">
                                            </td>
                                            <td>
                                                <input class="form-control barcode" name="barcode[]" type="text" id="barcode1" maxlength="256" value="<?php echo $row->barcode; ?>">
                                            </td>
                                            <td>
                                              <input type="hidden" id="stock_total" name="stock_total" value="">
                                                <input type="number" class="form-control form-text text-right" id="stock1" name="stock[]" placeholder="0.00" maxlength="32" value="<?php echo $row->stock; ?>">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control form-text text-right" id="cost1" name="cost[]" placeholder="0.00" maxlength="32" value="<?php echo $row->cost; ?>">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control form-text text-right" id="sale_price1" name="sale_price[]" placeholder="0.00"  maxlength="32" value="<?php echo $row->sale_price; ?>">
                                            </td>
                    ...
                    <br><br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                           <input type="text" class="form-control" id="unit_count" name="unit_count" placeholder="เช่น ตัว ชิ้น แพ็ค กล่อง..." value="<?php echo $data_unit_count;?>">
                        </div>
                      </div>
                      ...
                      <hr>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="hidden" id="product_location_value" name="product_location_value" value="<?php echo $data_store; ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="number" class="form-control" id="product_minimum" name="product_minimum" placeholder="จำนวน ..." value="<?php echo $data_product_minimum;?>">
                        </div>
                      </div>
...
<script type="text/javascript">
  ...
  var name1 = $('#product_detail_value').val();

  document.getElementById("product_detail").value = name1;

  var category1 = $('#product_category_value').val();

   $("#product_category").val(category1);
   // document.getElementById("product_category").value = category;


  var location1 = $('#product_location_value').val();
  $("#product_location").val(location1);
  // document.getElementById("product_location").value = location;
